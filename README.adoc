...
The default user on the Machine is "consumption" and a new SSH Keypair is generated to access the vm. You will find the require information in the terraform output and in the "output" folder.
